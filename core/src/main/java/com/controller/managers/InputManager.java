...
/**
 * Gestionnaire d'entrée pour traiter les commandes utilisateur.
 * <p>
 * Cette classe étend InputAdapter de LibGDX pour gérer les événements clavier
 * et mettre à jour les composants d'entrée des entités.
 */
