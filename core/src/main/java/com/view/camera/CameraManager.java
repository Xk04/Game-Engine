...
/**
 * Gestionnaire de caméra pour contrôler la vue du jeu.
 * <p>
 * Cette classe gère la caméra orthographique et le viewport pour suivre le joueur
 * et ajuster la vue selon la taille de la carte.
 */
