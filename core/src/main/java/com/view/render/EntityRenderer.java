...
import com.view.resources.TextureManager;
...
/**
 * Rendu des entités du jeu sur l'écran.
 * <p>
 * Cette classe utilise un SpriteBatch pour dessiner les sprites des entités
 * en fonction de leurs composants de position et de rendu.
 */
